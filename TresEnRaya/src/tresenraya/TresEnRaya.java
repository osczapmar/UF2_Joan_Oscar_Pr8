...
public class TresEnRaya {
                    ...
                    while (opcion != 3 && raya == false) { //Mientras no se acabe la jugada, se pueden revisar otras opciones
                        ...
                        switch (opcion) {
                            case 1:
                                ...
                                break;
                            case 2:
                                fila = IntoRange("Posición de la fila a comprobar: ", "Fuera del lí­mite de columnas", 1, columnas);
                                columna = IntoRange("Posición de la columna a comprobar: ", "Fuera del lí­mite de columnas", 1, columnas);
    ...
    public static boolean EnRaya(int[][] tablero, int fila, int columna) {
        ...
        if (columaux-1 <= tablero[fila].length - 4) {
